...
public class FindAverageSalary2 {
    public static void main(String[] args) {
        ...
        Map<String,Double> averageStream = employees.stream()
                .collect(Collectors.groupingBy(Employee::getDepartment,
                        Collectors.averagingDouble(Employee::getSalary)));

        averageStream.forEach((departament,averSalary)->
                System.out.println(departament+" -> $" + averSalary));
    }
}
